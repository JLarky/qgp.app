...
3. QGP is not attempting to solve every problem. You would need to rely on Astro and Vite to bring some of the integrations that QGP does not provide, or add some tools like testing and linting yourself.x
