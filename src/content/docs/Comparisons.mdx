...
<ul class="list-disc list-inside">
	<li>It is not extendable. It's difficult to add plugins or modify the webpack config.</li>
	<li>It is not flexible. You can only build client rendered single-page applications.</li>
	<li>It is not performant. It is slow in many ways-- HMR, build times, and user experience.</li>
	<li>It is not modern. The opinionated structure was great in 2016, but it isn't relevant now.</li>
</ul>
